...
<? include 'block/header.php'; ?>
	...
	<div class="bl1">
		<div class="bl1_a" style="background-image:url(/assets/img/bag/bl34.jpg)"></div>

		<div class="bl_c">
			<div class="bl1_c <?=($lang=='kz'?'bl1_c2':'')?>">
				<div class="bl1_offer" data-aos="fade-up" data-aos-delay="700">
					<h1>Курортная зона Сарыагаш <br> более 50-ти вариантов <br> уютного размещения</h1>
				</div>
				<div class="bl1_disc" data-aos="fade-up" data-aos-delay="800">
					<p>Минеральная вода Сарыагаш, <br> очищение, омоложение от 12 000 тг</p>
				</div>
